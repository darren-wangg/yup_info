...
Yup API documentation for internal use.
...
Fetch post information for a given vote/post.

Fetch comments on a given vote/post.

Fetch user interactions on a given vote/post.

Fetch a user's vote on a given vote/post (if it exists).
...
- [http://api.yup.io/levels/user/darren_yup](http://api.yup.io/levels/user/darren_yup) or [http://api.yup.io/accounts/darren_yup](http://api.yup.io/accounts/darren_yup)
...
- [https://app.yup.io/lists](https://app.yup.io/lists)
